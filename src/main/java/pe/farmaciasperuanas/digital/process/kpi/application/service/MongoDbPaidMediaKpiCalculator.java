...
import pe.farmaciasperuanas.digital.process.kpi.domain.port.service.MongoDbAggregationService;
import pe.farmaciasperuanas.digital.process.kpi.domain.port.service.PaidMediaKpiCalculatorService;
import pe.farmaciasperuanas.digital.process.kpi.infrastructure.KpiResultFormatter;
...
public class MongoDbPaidMediaKpiCalculator implements PaidMediaKpiCalculatorService {
    ...
    private final MongoDbAggregationService aggregationService;
    private final KpiResultFormatter kpiResultFormatter;
